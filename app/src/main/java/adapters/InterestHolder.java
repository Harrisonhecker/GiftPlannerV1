...
public class InterestHolder extends RecyclerView.ViewHolder {
    ...
    InterestHolder(LayoutInflater inflater, ViewGroup parent) {
        super(inflater.inflate(R.layout.interest_list_item, parent, false));
        mEventTextView = itemView.findViewById(R.id.interest_info);
    }
